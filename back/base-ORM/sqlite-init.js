  ...
  }
{
  ...
  if (!existe) {
    await db.run(
      "CREATE table veterinarios( legajo INTEGER NOT NULL PRIMARY KEY, nombre text NOT NULL, matricula text NOT NULL, fechaRegistro text NOT NULL, celular INTEGER NULL);"
    );
    console.log("tabla veterinarios creada!");
    await db.run(
      `insert into veterinarios values	
      (1245, 'Alejandro Alvarez', 'Mc2567','2003-02-25', 351256578), 
      (1456, 'Lucas Rodriguez', 'Mc8708','2009-10-12', 351984532), 
      (1890, 'Raul Mejia', 'Mc8908','2008-03-06', 351385478), 
      (1458, 'Nikol Fuentes', 'Mc9808','2008-09-30', 351117890),
      (1280, 'Daniel Suarez', 'Mc2108','2011-09-24', 351559399),
      (1254, 'Micaela Montes', 'Mc8007','2013-07-21', 351701230),
      (1268, 'Daniela Silvina', 'Mc5480','2003-03-25', 351256330),
      (1220, 'Cintia Carmona', 'Mc5484','2012-04-12', 351789011),
      (1281, 'Juan González', 'Mc5481','2005-06-08', 351254101),
      (1239, 'Pepe Sanches', 'Mc4878','2008-08-01', 351659840)`
    );
  }
