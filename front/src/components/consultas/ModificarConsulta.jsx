...
export default function ModificarConsulta({ventanaModificacionRef, consulta, cerrarVentanaModificacion, modificar }) {
    ...
    <div ref={ventanaModificacionRef} className="mt-3"> 
        <form  onSubmit={handleSubmit(onSubmit) } className="card p-3" >
            ...
            <input type="text" readOnly className="form-control" defaultValue={consulta.IdConsulta} {...register("IdConsulta", {required:true, pattern: /^\d{4,}$/})} />
            ...
            <input type="text" className="form-control" defaultValue={consulta.Observacion} {...register("Observacion")}/>
